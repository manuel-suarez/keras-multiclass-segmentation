...
BATCH_SIZE = 4
NUM_CLASSES = 20
DATA_DIR = os.path.join(os.path.expanduser('~'), 'data', 'instance-level_human_parsing', 'instance-level_human_parsing')
...
train_masks = sorted(glob(os.path.join(TRAIN_DIR, "Category_ids/*")))
